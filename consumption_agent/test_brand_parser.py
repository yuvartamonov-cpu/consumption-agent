...
all_ok &= test("p1", "пиджак lardini 6 мес", "пиджак", "lardini", 6)

print("2. поло hamington 3 мес")
all_ok &= test("p2", "поло hamington 3 мес", "поло", "hamington", 3)

print("3. стремянка 5 ступеней (без срока)")
all_ok &= test("p3", "стремянка 5 ступеней", "стремянка 5 ступеней", None, None)

print("4. пиджак circolo замена 24 мес")
all_ok &= test("p4", "пиджак circolo замена 24 мес", "пиджак", "circolo", 24)

print("5. Носки | бренд Nike | замена 12 мес")
all_ok &= test("p5", "носки | бренд Nike | замена 12 мес", "носки", "Nike", 12)

print("6. Пылесос | бренд Xiaomi | замена 60 мес")
all_ok &= test("p6", "Пылесос | бренд Xiaomi | замена 60 мес", "Пылесос", "Xiaomi", 60)

print("7. Куртка The North Face замена 36 мес")
all_ok &= test("p7", "Куртка The North Face замена 36 мес", "Куртка", "The North Face", 36)

print("8. Джинсы Levi's 501 (без срока)")
all_ok &= test("p8", "Джинсы Levi's 501", "Джинсы", "Levi's 501", None)

print("9. Ноутбук Lenovo ThinkPad X1 Carbon замена 48 мес")
all_ok &= test("p9", "Ноутбук Lenovo ThinkPad X1 Carbon замена 48 мес", "Ноутбук", "Lenovo ThinkPad X1 Carbon", 48)

print("10. Только название без бренда и срока")
all_ok &= test("p10", "футболка", "футболка", None, None)

print("11. Рубашка белая (цвет не бренд)")
all_ok &= test("p11", "рубашка белая", "рубашка белая", None, None)
